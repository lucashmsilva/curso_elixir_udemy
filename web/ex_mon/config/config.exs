...
config :ex_mon, ExMonWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "S32CTHKncRQrpBnKEVR1y9eYIAHbdA3lm1hN7QEVlCDevOTEhdfew/P0SrQ1TLjF",
  render_errors: [view: ExMonWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: ExMon.PubSub,
  live_view: [signing_salt: "r5GfOO+s"]
...
config :ex_mon, ExMonWeb.Auth.Guardian,
       issuer: "ex_mon",
       secret_key: "rgswBFXx/LQ2eY3B57IZJDtjBuiAyhDamoeq+F/wXWOtgFyHrVZNZaXvKRbvNXsc"
